...
export default function TestimonialsSlider() {
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-900 overflow-hidden">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative flex items-center gap-4">
          ...
          <button
            onClick={prev}
            className="shrink-0 w-11 h-11 rounded-full bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 shadow-sm flex items-center justify-center text-zinc-400 dark:text-zinc-500 hover:text-teal-600 hover:border-teal-300 dark:hover:bg-zinc-700 hover:shadow-md transition-all"
            aria-label="Previous"
          >
          ...
          {/* Card */}
          <div
            className={`flex-1 bg-white dark:bg-zinc-800 rounded-3xl border border-zinc-200 dark:border-zinc-700 shadow-md p-8 sm:p-10 transition-all duration-300 ease-out ${slideClass}`}
          >
            {/* Quote icon */}
            <svg className="w-12 h-12 text-zinc-100 dark:text-zinc-700 mb-6" fill="currentColor" viewBox="0 0 32 32">
            ...
            {/* Review */}
            <p className="text-zinc-700 dark:text-zinc-300 text-lg leading-relaxed font-medium mb-8">
              &ldquo;{t.review}&rdquo;
            </p>

            {/* Patient row */}
            <div className="flex items-center gap-4 pt-6 border-t border-zinc-100 dark:border-zinc-700">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-bold text-zinc-900 dark:text-white text-base">{t.name}</p>
                <p className="text-sm text-zinc-400 dark:text-zinc-500">{t.tag}</p>
              </div>
            ...
            <button
              ...
              className={`transition-all duration-300 rounded-full ${
                i === current
                  ...
                  : "w-2.5 h-2.5 bg-zinc-200 dark:bg-zinc-700 hover:bg-zinc-300"
              }`}
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-zinc-500 dark:text-zinc-400">
          <div className="flex items-center gap-2">
            ...
            <span><strong className="text-zinc-900 dark:text-white">4.9 / 5</strong> average rating</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span><strong className="text-zinc-900 dark:text-white">50,000+</strong> patients served</span>
          </div>
          <div className="hidden sm:block w-px h-4 bg-zinc-200 dark:bg-zinc-700" />
          <div className="flex items-center gap-2">
            ...
            <span><strong className="text-zinc-900 dark:text-white">30+</strong> countries reached</span>
          </div>
        </div>
      </div>
    </section>
