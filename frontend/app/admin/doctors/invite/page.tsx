    ...
    <main className="min-h-screen bg-zinc-50 p-8">
      <div className="max-w-lg mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-zinc-900">Invite a Doctor</h1>
            <p className="text-sm text-zinc-500 mt-0.5">Send a registration link to a doctor&apos;s email.</p>
          </div>
