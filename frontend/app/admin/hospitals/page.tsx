    ...
    <main className="min-h-screen bg-zinc-50 p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-zinc-900">Hospitals</h1>
            <p className="text-sm text-zinc-500 mt-0.5">Manage partner hospitals.</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {hospitals.map((h) => (
              <Card key={h.id} className="border border-zinc-200 shadow-sm">
                <CardContent className="pt-4 flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    <p className="font-medium text-zinc-900">{h.name}</p>
                    <p className="text-sm text-zinc-500">{h.city}, {h.state}, {h.country}</p>
                    {h.accreditations && (
                      <p className="text-xs text-zinc-400 mt-0.5">Accreditations: {h.accreditations}</p>
                    )}
                    <p className="text-xs text-zinc-400 mt-0.5 font-mono">/{h.slug}</p>
                  </div>
